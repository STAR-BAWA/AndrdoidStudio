...
import com.example.gpay.databinding.ActivityCheckoutBinding;
import com.example.gpay.util.PaymentsUtil;
...
public class CheckoutActivity extends AppCompatActivity {
  ...
  private JSONObject fetchRandomGarment() {
    ...
    if (garmentList == null) {
      garmentList = Json.readFromResources(this, R.drawable.polo_shirt_image);
    }
