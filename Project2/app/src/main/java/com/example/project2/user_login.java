    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Forgot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(user_login.this, "Sucess", Toast.LENGTH_LONG).show();
        ...
        loginVendor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              {
                  Toast.makeText(user_login.this, "Please enter login details", Toast.LENGTH_SHORT).show();
              }
              else {
                  FirebaseAuth auth1 = FirebaseAuth.getInstance();
                  auth1.signInWithEmailAndPassword(mail, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                      @Override
                      public void onComplete(@NonNull Task<AuthResult> task) {

//                        Toast.makeText(sellerLogin.this, "Hello", Toast.LENGTH_SHORT).show();
                          if (task.isSuccessful()) {
                              Toast.makeText(user_login.this, "Authenticated", Toast.LENGTH_SHORT).show();
                              Intent it = new Intent(user_login.this,com.example.project2.user_home.class);
                              ...
                              Toast.makeText(user_login.this, "No user found ", Toast.LENGTH_SHORT).show();
                          }
                      }
